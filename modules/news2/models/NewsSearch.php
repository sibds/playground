...
class NewsSearch extends News{
    ...
    */
    ...
    {
        return [
            [['id', 'category_id', 'created_at', 'created_by', 'updated_at', 'updated_by', 'removed', 'locked'], 'integer'],
            [['name', 'url', 'image', 'date_public', 'annotation', 'content', 'layout'], 'safe'],
        ];
    }
    ...
    */
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'date_public', $this->date_public])
